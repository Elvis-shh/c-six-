...
('rdExpense', '研发费用', '亿', 0, 'expense', '研发费用反映公司在技术、产品和长期竞争力上的投入，科技、医药和高端制造公司尤其重要。', 11),
('rdExpenseRatio', '研发费用率', '%', 1, 'ratio', '研发费用率 = 研发费用 / 营业收入 × 100%，用于观察研发投入强度和长期创新能力。', 12),
('operatingCost', '营业成本', '亿', 0, 'expense', '营业成本是与主营业务收入直接匹配的成本，常用于计算毛利率。', 13),
('sellingExpense', '销售费用', '亿', 0, 'expense', '销售费用反映渠道、营销和销售体系投入。', 14),
('adminExpense', '管理费用', '亿', 0, 'expense', '管理费用反映公司日常管理和总部运营开支。', 15),
('financeExpense', '财务费用', '亿', 0, 'expense', '财务费用通常与利息收入、利息支出和汇兑损益相关，可辅助判断融资压力。', 16),
('eps', '基本每股收益', '元', 0, 'profit', '基本每股收益表示每股普通股对应的利润，是横向比较盈利能力的常用指标。', 17);
